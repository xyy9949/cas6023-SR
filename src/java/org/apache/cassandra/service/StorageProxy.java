...
public class StorageProxy implements StorageProxyMBean
{
    ...
    throws UnavailableException, IsBootstrappingException, ReadTimeoutException, WriteTimeoutException, InvalidRequestException
    {
        ...
        while (System.nanoTime() - start < timeout)
        {
            ...
            logger.info("[DIKAI] Reading existing values for CAS precondition");
            ...
            {
                logger.info("[DIKAI] CAS precondition {} does not match current values {}", expected, current);
            ...
            logger.info("[DIKAI] CAS precondition is met; proposing client-requested updates for {}", ballot);
